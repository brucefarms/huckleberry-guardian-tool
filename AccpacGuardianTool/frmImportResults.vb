Public Class frmImportResults
    ...
    Public Sub New(ByVal s As AccpacCOMAPI.AccpacSession, ByVal r As String)
        InitializeComponent()
    ...
    Private Sub frmImportResults_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
